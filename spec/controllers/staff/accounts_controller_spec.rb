...
describe Staff::AccountsController do #spell miss AccountsControll'l'er
  describe '#update' do
    ...
    example '例外ActionController::ParameterMissingが発生' do
      bypass_rescue
      expect {patch :update, id: staff_member.id}. #Needs to be {}, not ()
    ...
    example 'end_dateの値は書き換え不可' do
      ...
      expect{
        patch :update, id: staff_member.id, staff_member: params_hash #<- forgot to add 'staff_member: params_hash'
